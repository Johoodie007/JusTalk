  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      SizedBox(
              ...
              child: Container(
                padding: EdgeInsets.fromLTRB(10, 12.1, 25.5, 23),
                child: Stack(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(22.1, 0, 12.6, 27.9),
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 2, 11.1, 0.5),
                                        child: SizedBox(
                                          width: 25.1,
                                          height: 17.6,
                                          child: SvgPicture.asset(
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(39.4, 0, 39.4, 135.5),
                            child: Align(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0, 24.8, 0, 0),
                                    child: Text(
                                      'Just Talk',
                                      style: GoogleFonts.getFont(
                                        'Inter',
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(0, 0, 8.7, 49.6),
                            child: RichText(
                              text: TextSpan(
                          ...
                          ',
                                ...
                                children: [
                                  TextSpan(
                                    text: 'Your Information Is Totally Safe With Us',
                                    style: GoogleFonts.getFont(
                                      'Inter',
                                      fontWeight: FontWeight.w700,
                                      fontSize: 20,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 0, 30, 84),
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: Opacity(
                                opacity: 0.4,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 0, 30, 92),
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: Opacity(
                                opacity: 0.4,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 0, 30, 93),
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: Opacity(
                                opacity: 0.4,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(30, 0, 30, 44.9),
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: Opacity(
                                opacity: 0.4,
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(9.1, 0, 0, 30.1),
                            child: Stack(
                              children: [
                                Positioned(
                                  left: -15.2,
                          ...
                          Container(
                                  width: 404.1,
                                  padding: EdgeInsets.fromLTRB(15.2, 11.3, 0, 11.7),
                                  child: Text(
                                    'Sign Up',
                                    style: GoogleFonts.getFont(
                                      'Inter',
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(32.3, 0, 32.3, 0),
                            child: Align(
