...
class GetStarted extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(32.1, 12.1, 32.1, 217.8),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(0, 0, 0, 184.8),
              child: Align(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(2.6, 0, 0, 114.7),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 2.2, 2.8),
                    child: Container(
                      decoration: BoxDecoration(
                        color: Color(0xFFFFFFFF),
                      ),
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0, 26.2, 0, 0),
                    child: Text(
                      'Just Talk',
                      style: GoogleFonts.getFont(
                        'Inter',
            ...
            Container(
              margin: EdgeInsets.fromLTRB(7.7, 0, 0, 115.5),
              child: SizedBox(
                width: 278,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
            ...
            Container(
              margin: EdgeInsets.fromLTRB(4.9, 0, 5.2, 0),
              child: Text(
                '       The best counseling
            from the best psychologists',
                style: GoogleFonts.getFont(
                  'Inter',
                  fontWeight: FontWeight.w700,
                  fontSize: 26,
