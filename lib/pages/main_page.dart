  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      SizedBox(
              ...
              height: 926,
              child: Container(
                padding: EdgeInsets.fromLTRB(7, 12, 14, 0),
                child: Stack(
                  ...
                  children: [
                    ...
                    SizedBox(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.fromLTRB(30, 0, 30, 121),
                                      child: Align(
                                    ...
                                    Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.fromLTRB(18, 18, 21, 9.8),
                                          child: Column(
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(25.1, 0, 24, 25),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                            ...
                            child: Align(
                              ...
                              child: SizedBox(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.fromLTRB(0, 2.7, 0, 4.7),
                                      child: Row(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: SizedBox(
                                  width: 356,
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(15.1, 10, 14.2, 13),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                          ...
                          Container(
                            margin: EdgeInsets.fromLTRB(22, 0, 22, 119),
                            child: Align(
                              alignment: Alignment.topLeft,
                              child: Text(
                                'Recommended Doctors',
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                padding: EdgeInsets.fromLTRB(18, 18, 21, 15.8),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        margin: EdgeInsets.fromLTRB(0, 0, 9.1, 272),
                                        child: Opacity(
                                          opacity: 0.6,
                                          child: Text(
                                            'Dr. Elias Omar',
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: SizedBox(
                          ...
                          height: 112,
                          child: Container(
                            padding: EdgeInsets.fromLTRB(0, 20, 0, 62),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
